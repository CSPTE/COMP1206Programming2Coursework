...
public class Grid {
    ...
    /**
     * Checks if a GamePiece can be played on specified coordinates
     * @param piece GamePiece we wish to play
     * @param placeX X coordinate of block pressed
     * @param placeY Y coordinate of block pressed
     * @return whether we can play a piece
     */
    ...
    /**
     * Plays a GamePiece
     * @param piece piece we desire to play
     * @param placeX X coordinate of block pressed
     * @param placeY Y coordinate of block pressed
     */
