...
public class GameWindow {
     ...
     * @param array passes on an array containing the online scoreboard
     */
    public void startScores(ArrayList<String> array){
        loadScene(new ScoresScene(this, array));
    }
    /**
     * Display the new high score scene
     * @param array passes on an array containing the online scoreboard
     * @param game passes on the game played
     */
    public void startNewHighScores(Game game, ArrayList<String> array){
        loadScene(new NewHighScoreScene(this, game, array));
    }
    /**
